...
import laser.ddg.gui.MossCompare;
 ...
 *
 */
public class CompareScriptsMossCommand implements ActionListener {
	/**
	...
	private static void execute() {
		...
		JPanel diffPanel = new MossCompare(ddgExplorer, jenaLoader);
		...
		//new tab!
		ddgExplorer.addTab("Comparing R Scripts:Moss", diffPanel);
	}
